...
<html lang="en">
	<head>
		...
		<!--Custom JavaScript - enda kirjutatud javascript - praegu on tühi, jääb projekti, et mitte arhidektuuri lõhkuda.-->
		<!--<script async src="<?php echo base_url(); ?>assets/js/custom.js"></script>-->
		
		<!--JQuery-->
		<script async src="<?php echo base_url(); ?>assets/js/jquery-1.11.2.min.js"></script>
		...
		<script async src="<?php echo base_url(); ?>assets/js/jquery.dataTables.min.js"></script>
